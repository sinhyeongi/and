                ...
                if (sharedPreferences.getInt("Save1_Level", 0) > 0) {
                    ...
                    builder.setNegativeButton("예", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            editor.putInt("Save1_atk",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save1_atk_btn",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save1_defence",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save1_defence_btn",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save1_luk",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save1_luk_btn",sharedPreferences.getInt("HP_btn",0));
                            editor.commit();
                            textView1.setText(String.valueOf(sharedPreferences.getInt("Save1_Level", 0)));
                            textView2.setText(String.valueOf(sharedPreferences.getInt("Save1_money", 0)));
                            return;
                ...
                if (sharedPreferences.getInt("Save2_Level", 0) > 0) {
                    ...
                    builder.setNegativeButton("예", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            editor.putInt("Save2_atk",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save2_atk_btn",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save2_defence",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save2_defence_btn",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save2_luk",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save2_luk_btn",sharedPreferences.getInt("HP_btn",0));
                            editor.commit();
                            textView3.setText(String.valueOf(sharedPreferences.getInt("Save2_Level", 0)));
                            textView4.setText(String.valueOf(sharedPreferences.getInt("Save2_money", 0)));
                            return;
                ...
                if (sharedPreferences.getInt("Save3_Level", 0) > 0) {
                    ...
                    builder.setNegativeButton("예", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            editor.putInt("Save3_atk",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save3_atk_btn",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save3_defence",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save3_defence_btn",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save3_luk",sharedPreferences.getInt("HP_btn",0));
                            editor.putInt("Save3_luk_btn",sharedPreferences.getInt("HP_btn",0));
                            editor.commit();
                            textView5.setText(String.valueOf(sharedPreferences.getInt("Save3_Level", 0)));
                            textView6.setText(String.valueOf(sharedPreferences.getInt("Save3_money", 0)));
                            return;
